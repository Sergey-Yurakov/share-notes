                    ...
                    <div className="text">
                        <form action="" onSubmit={loadDataFromForm} className={formClass}>
                            <div className="form-group">
                                ...
                                <textarea name="note" className="form-control" defaultValue="Содержимое заметки" id="note"/>
                        ...
                        <div className={lineClass}>
                            ...
                            <div className="text-right"><button onClick={function () { window.location.reload() }} className="btn btn-info">Создать еще один note</button></div>
                        </div>
                    </div>
                </div>
            </div>
